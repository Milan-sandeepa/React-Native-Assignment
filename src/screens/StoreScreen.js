...
const StoreScreen = ({navigation}) => {
  ...
  useEffect(() => {
    if (isFocused) {
      dispatch(getAllItemAction(data)); // Perform API call when screen is focused
    }
  }, [isFocused]);
  ...
  const addItemHandler = () => {
    navigation.navigate('StoreAddItemScreen');
  };
      ...
      <View style={styles.container}>
        ...
        <View
          ...
          <View style={styles.name}>
            ...
            <Text>List Your Items Here.!</Text>
          </View>
