...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    // ** Reset
    case resetStationaryItemSaveActionTypes.RESET_ACTION:
      return {
        ...state,
        saveItemLoading: false,
        saveItemSuccess: null,
    ...
    case resetUpdateStationaryItemActionTypes.RESET_ACTION:
      return {
        ...state,
        updateItemLoading: false,
        updateItemSuccess: null,
    ...
    case resetDeleteStationaryItemActionTypes.RESET_ACTION:
      return {
        ...state,
        deleteItemLoading: false,
        deleteItemSuccess: null,
